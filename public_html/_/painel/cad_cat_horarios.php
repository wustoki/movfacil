...
$ch ->cad_dinamico_horario($cidade_id, $nome, $segunda, $terca, $quarta, $quinta, $sexta, $sabado, $domingo, $adicional);
echo "<script>alert('Cadastrado com sucesso!');window.location.href='dinamico_horario.php';</script>";
?>