                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($motoristas as $motorista) {
                            ...
                            //se saldo for negativo, não exibe
                            ...
                            if ($status == "ABERTO") {
                                ...
                                echo '<td><a href="#" onclick="acertar(' . $motorista['id'] . ', \'' . $date_from . '\')" class="btn btn-primary btn-sm">Pagar</a></td>';
...
<script>
    function acertar(motorista_id, semana) {
